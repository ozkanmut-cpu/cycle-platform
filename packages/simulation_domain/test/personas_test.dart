...
void main() {
  ...
  test('same seed produces stable patient persona', () {
    expect(jsonEncode(generator.patient(20260915).toJson()),
        jsonEncode(generator.patient(20260915).toJson()));
  });

  test('all persona roles round-trip without semantic loss', () {
    final personas = <SimulationPersona>[
      generator.patient(11),
      generator.partner(22),
      generator.doctor(33)
    ];
    for (final persona in personas) {
      final decoded = SimulationPersona.fromJson(
          (jsonDecode(jsonEncode(persona.toJson())) as Map)
              .cast<String, Object?>());
  ...
  test('patient wearable requires an explicit data source', () {
    ...
    final invalid = PatientPersona(
        id: base.id,
        core: PersonaCore(
            age: base.core.age,
            healthLiteracy: base.core.healthLiteracy,
            digitalLiteracy: base.core.digitalLiteracy,
            accessibilityNeeds: base.core.accessibilityNeeds,
            privacySensitivity: base.core.privacySensitivity,
            dataDensity: base.core.dataDensity,
            wearableUse: WearableUse.regular,
            loggingBehaviour: base.core.loggingBehaviour,
            goals: base.core.goals,
            fears: base.core.fears,
            expectedMentalModel: base.core.expectedMentalModel),
        cycleLifeStage: base.cycleLifeStage,
        conditions: base.conditions,
        medications: base.medications,
        symptomBurden: base.symptomBurden,
        missingnessPattern: base.missingnessPattern,
        healthDataSources: const []);
