...
List<RelationshipBehaviorScenario> buildCanonicalRelationshipBehaviorScenarios(
  ...
  final scenarios = <RelationshipBehaviorScenario>[
    ...
    _canonicalBehaviorScenario(
      id: 'signal.supersession.version',
      seed: seed,
      at: at,
      family: RelationshipBehaviorScenarioFamily.signalProjection,
      safeControl: true,
      riskTags: const <String>{'ordering', 'lifecycle'},
      expectedFacts: const <String, Object?>{
        'selectedSignalIds': <String>['signal-v2'],
        'projectedSignalIds': <String>['signal-v2'],
      },
      payload: <String, Object?>{
        'signals': <Object?>[
          <String, Object?>{
    ...
    _canonicalBehaviorScenario(
      ...
      riskTags: const <String>{'visibility', 'permission', 'phase9Reuse'},
      expectedFacts: const <String, Object?>{
        'contextCategories': <String>['cycle'],
        'contextVisibilities': <String>['engineOnly'],
        'contextRawValues': <Object?>[null],
      },
      payload: <String, Object?>{
        'operation': 'context',
        'capability': 'view',
        'entries': <Object?>[
          <String, Object?>{
            ...
            'visibility': 'engineOnly',
            'value': 'sensitive-cycle-context',
          },
        ],
        'grants': <Object?>[
          _canonicalRelationshipGrant(
            id: 'context-cycle-view',
            ownerId: 'patient-1',
            recipientId: 'partner-1',
            category: 'cycle',
            capability: 'view',
    ...
    _canonicalBehaviorScenario(
      id: 'novelty.constraints-and-ranking',
      seed: seed,
      at: at,
      family: RelationshipBehaviorScenarioFamily.novelty,
      safeControl: true,
      riskTags: const <String>{'ordering', 'suppression', 'phase9Reuse'},
      expectedFacts: const <String, Object?>{
        'suggestionIds': <String>['eligible-b', 'eligible-a'],
        'suggestionScores': <int>[120, 110],
      },
      payload: <String, Object?>{
        'dna': const <String, Object?>{
          'preferredTags': <String>['cozy', 'creative'],
          'dontSuggestTags': <String>['blocked'],
          'dontSuggestCandidateIds': <String>['banned-id'],
          'maxBudget': 50,
        ...
        'candidates': const <Object?>[
          ...
          <String, Object?>{
            'id': 'eligible-b',
            'category': 'date',
            'title': 'Creative cozy date',
            'tags': <String>['cozy', 'creative'],
            'cost': 30,
            'durationMinutes': 45,
            'energy': 'low',
            'setting': 'home',
          ...
          <String, Object?>{
            'id': 'blocked-tag',
            'category': 'date',
            'title': 'Blocked tag date',
            'tags': <String>['blocked', 'cozy'],
            'cost': 20,
            'durationMinutes': 30,
            'energy': 'low',
            'setting': 'home',
        ...
        'history': <Object?>[
          <String, Object?>{
            'candidateId': 'recent',
            'usedAt': at.subtract(const Duration(days: 1)).toIso8601String(),
          },
        ],
        'grants': <Object?>[
          _canonicalRelationshipGrant(
            id: 'novelty-ranking-intelligence',
            ownerId: 'patient-1',
            recipientId: 'partner-1',
            category: 'relationship.novelty.date',
            capability: 'relationshipIntelligence',
    ...
    _canonicalBehaviorScenario(
      id: 'partner-home.authorized-surfaces',
      seed: seed,
      at: at,
      family: RelationshipBehaviorScenarioFamily.partnerHome,
      safeControl: true,
      riskTags: const <String>{'permission', 'visibility', 'phase9Reuse'},
      expectedFacts: const <String, Object?>{
        'homeBuildFailedClosed': false,
        'homeTabs': <String>[
          'now',
    ...
    _canonicalBehaviorScenario(
      ...
      expectedFacts: const <String, Object?>{
        'notificationPresented': true,
        'notificationRedacted': true,
        'notificationBody': 'New Partner update.',
      },
      payload: <String, Object?>{
        'kind': 'relationship',
        'mode': 'categoryOnly',
        ...
        'grants': <Object?>[
          _canonicalRelationshipGrant(
            id: 'notification-category-notify',
            ownerId: 'patient-1',
            recipientId: 'partner-1',
            category: 'relationship.update',
            capability: 'notify',
    ...
    _canonicalBehaviorScenario(
      ...
      expectedFacts: <String, Object?>{
        'intimacyDecisionKinds': const <String>['mutuallyWilling'],
        'intimacyExpiresAt': <String>[
          at.add(const Duration(minutes: 20)).toIso8601String(),
        ],
      },
      payload: _canonicalIntimacyPayload(
        ...
        willingness: <Object?>[
          ...
          _canonicalIntimacyWillingness(
            ...
            willingness: 'yes',
            createdAt: at.subtract(const Duration(minutes: 1)),
            expiresAt: at.add(const Duration(minutes: 20)),
          ),
        ],
      ),
    ),
